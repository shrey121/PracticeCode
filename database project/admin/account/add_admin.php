...
<form name="loginform" action="admin_add_exec.php" method="post">
<table width="309" border="0" align="center" cellpadding="2" cellspacing="5">
  ...
  <tr>
    <td width="116"><div align="right">Admin ID*</div></td>
    <td width="117"><input name="aid" type="text" /></td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><input name="aphone" type="text" /></td>
  </tr>
  <tr>
